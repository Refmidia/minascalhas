      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 lg:pt-24 pb-32 lg:pb-40 grid lg:grid-cols-2 gap-12 items-center">
        <div className="max-w-xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#agendar" className="inline-flex items-center gap-2 rounded-full bg-brand-green hover:bg-brand-green-dark text-white font-semibold px-6 py-3.5 transition shadow-sm">
              Agendar visita <ArrowRight size={16} aria-hidden="true" />
            </a>
          ...
          <div className="mt-8 flex items-center gap-2 text-sm text-brand-muted">
            <ShieldCheck size={18} className="text-brand-green" aria-hidden="true" />
        ...
        <div className="relative">
          ...
          >
            <img
              src={heroImg}
              alt="Calhas metálicas recém-instaladas em telhado residencial moderno"
              width={1280}
              height={1280}
              fetchPriority="high"
              decoding="async"
          ...
          <div className="absolute -bottom-6 -left-6 hidden md:block h-24 w-24 rounded-2xl bg-brand-green/10 border border-brand-green/20" aria-hidden="true" />
        </div>
      </div>
    </section>
  );
